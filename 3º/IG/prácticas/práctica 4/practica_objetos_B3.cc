...
switch (toupper(Tecla1)){
	...
	case '4': {modo=SOLID_CHESS;break;}
        ...
        case 'T': {t_objeto=PIRAMIDE;dibujo=-1;break;}
        case 'Y': {t_objeto=CUBO;dibujo=-1;break;}
        case 'U': {t_objeto=OBJETO_PLY;dibujo=-1;break;}
        case 'O': {t_objeto=CILINDRO;dibujo=-1;break;}
        case 'P': {t_objeto=ESFERA;dibujo=-1;break;}
        case 'L': {t_objeto=CONO;dibujo=-1;break;}
        case 'I': {t_objeto=ROTACION;dibujo=-1;break;}
        case 'R': {t_objeto=ARTICULADO;dibujo=1;break;}
        case '5': {
                if(dibujo==-1) modo = POINTS;
                else modo=RUBIK;
                break;
                }
        if(dibujo == 1){
