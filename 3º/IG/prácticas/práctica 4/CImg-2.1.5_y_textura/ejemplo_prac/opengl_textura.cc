...
// ~~~~~ ÁRBOL ~~~~~~~
// vertices
GLfloat vertices[] = {-1.0, 0.0, 1.0, 1.0, 0.0, 1.0, 0.0, 2.0, 0.0,
                        1.0, 0.0, 1.0, 1.0, 0.0, -1.0, 0.0, 2.0, 0.0,
                        1.0, 0.0, -1.0, -1.0, 0.0, -1.0, 0.0, 2.0, 0.0,
                        -1.0, 0.0, -1.0, -1.0, 0.0, 1.0, 0.0, 2.0, 0.0};
// coordenadas de la textura
GLfloat texVertices[] = {0.0, 1.0, 1.0, 1.0, 0.5, 0.0,
...
GLfloat vertices2[] = {-4.0, 0.0, 4.0,    4.0, 0.0, 4.0,    4.0, 0.0, -4.0,    -4.0, 0.0, -4.0};
GLfloat texVertices2[] = {0.0, 1.0,    0.5, 1.0,     0.5, 0.5,    0.0, 0.5};
...
void Init(int argc, char **argv){
   ...
   gluPerspective( 40.0, 600/600.0f, 0.1, 150);
  
   prepara_textura("./abeto.jpg", &textura_id);
   prepara_textura("./puente_rio.jpg", &textura_id_2);
}
...
void dibuja (void)
{
   ...
   glBindTexture(GL_TEXTURE_2D, textura_id_2);
