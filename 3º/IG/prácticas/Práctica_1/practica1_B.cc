...
void draw_objects()
{
 //piramide.draw_aristas(1.0,0.5,0.6);
 //cubo.draw_solido(1.0, 0.5, 6);
 switch(modelo){
		case 1:
		switch (modo){
				case 1: //Puntos
					...
					break;
				case 2: //Aristas
					cubo.draw_aristas(1.0,0.5,0.0,4);
					break;
				case 3: //Solido
					cubo.draw_solido(1.0,0.5,0.2);
					break;
				case 4: //Ajedrez
					cubo.draw_solido_ajedrez(1.0,0.5,0.0,0.2,0.7,0.6);
					break;
			}
		break;
		...
		switch (modo){
				case 1: //Puntos
					...
					break;
				case 2: //Aristas
					piramide.draw_aristas(1.0,0.5,0.0,4);
					break;
				case 3: //Solido
					piramide.draw_solido(1.0,0.5,0.2);
					break;
				case 4: //Ajedrez
					piramide.draw_solido_ajedrez(1.0,0.5,0.0,0.2,0.7,0.6);
					break;
			}
		break;
	}
